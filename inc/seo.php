...
add_action('wp_head', function () {
    ...
    if (has_post_thumbnail()) {
        ...
        echo '<meta property="og:image" content="https://hramspiridona-vrn.ru/wp-content/uploads/2025/03/snimok-ekrana-2025-03-05-164602-1024x413.jpg" />' . "\n";
        echo '<meta property="og:image:width" content="1024">' . "\n";
        echo '<meta property="og:image:height" content="413">' . "\n";
    }
});
