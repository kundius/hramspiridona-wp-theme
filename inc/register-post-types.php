...
function register_post_types()
{
  ...
  register_post_type('minister', [
    ...
    'labels' => [
      ...
      'add_new_item' => 'Добавление служителя', // заголовка у вновь создаваемой записи в админ-панели.
      'edit_item' => 'Редактирование служителя', // для редактирования типа записи
